...
export const OfferCard = ({ title, description, price, image }) => {
    return (
        <motion.div
            ...
            className="relative bg-white w-full  h-full overflow-hidden flex items-center p-6 shadow-lg rounded-lg"
        >
            ...
            >
                ...
                >
                    <a
                        href="#"
                        className="text-xs font-bold text-gray-900 px-4 py-2 border border-gray-400 rounded-l-full transition-all duration-300 hover:bg-gray-900 hover:text-white"
                    >
                        ${price}
                    </a>
                    <a
                        href="#"
                        className="text-xs font-bold text-gray-900 px-4 py-2 border border-gray-400 rounded-r-full flex items-center gap-2 transition-all duration-300 hover:bg-gray-900 hover:text-white"
                    >
...
export const OfferBanner = ({ product }) => {
    return (
        <AnimatePresence>
            <motion.section
                key={product.id}
                className="relative grid grid-cols-1 md:grid-cols-[0.9fr_1fr] h-full w-full bg-white p-10 rounded-lg shadow-lg"
                initial="hidden"
                animate="visible"
                exit="exit"
                variants={{
            ...
            >
                ...
                <div className="p-6">
                    <h1 className="text-gray-800 font-extrabold text-2xl mb-1">
                        {product.name}
                    </h1>
