        ...
        <Container>
            <div className="h-auto md:h-[40vh] w-full bg-gradient-to-r from-slate-300 to-slate-400 rounded-xl flex flex-col md:flex-row items-center justify-center overflow-hidden shadow-lg p-4 gap-6">
                ...
                >
                    ...
                    <motion.div
                        animate={{
                            y: [-12, 12],  // Moves up & down
                            rotate: [-5, 2], // Rotates left & right
                        }}
                        transition={{
                            duration: 3,
                            repeat: Infinity,
                ...
                >
                    <motion.p className="text-2xl md:text-4xl font-bold text-gray-100">{ads.title}</motion.p>
                    <motion.p className="text-lg text-gray-100">{ads.subtitle}</motion.p>
                    <motion.p className="text-sm text-gray-800 font-medium">{ads.offer}</motion.p>
